        ...
        <div style={{ borderTop: "1px solid rgba(212,168,83,.15)", paddingTop: "1.5rem", display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: ".5rem" }}>
          ...
          <p style={{ fontSize: ".8rem", opacity: .5, margin: 0 }}>
            ...
            <a
              ...
              title="Mohamed Robleh"
              style={{ color: "inherit", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "5px", opacity: 1 }}
              onMouseEnter={e => e.currentTarget.querySelector("svg").style.color = "#25D366"}
              onMouseLeave={e => e.currentTarget.querySelector("svg").style.color = "rgba(255,255,255,.4)"}
            >
              Mohamed Robleh
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                style={{ width: 15, height: 15, color: "rgba(255,255,255,.4)", transition: "color .3s", flexShrink: 0 }}
              >
